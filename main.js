...
var lenght_of_name_student_array=name_of_student_array.length;
console.log(lenght_of_name_student_array);

for (var k=0; k<lenght_of_name_student_array; k++)
...
{
    display_student_sorting.push("<h4> Name-"+ name_of_student_array[k]+"</h4>")
